...
export interface PollStationData {
  ...
  /** Timestamp when port 1 status last changed (Iberdrola API) */
  port1_update_date: string | null;
  /** Timestamp when port 1 status actually changed (DB trigger) */
  ...
  /** Timestamp when port 2 status last changed (Iberdrola API) */
  port2_update_date: string | null;
  /** Timestamp when port 2 status actually changed (DB trigger) */
